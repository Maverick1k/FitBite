...
<body>
  <section class="hero">
    ...
    <div class="btn-group">
      <a href="recepies.php"><button class="btn-filled-dark" id="gold" <?php echo $_SESSION['user_data']['subscription']==''?'disabled':''; ?> > Delicious Recepies </button></a>
    ...
    <ul class="services">
      <li class="card-large card-dark card-wide" id="serv-groom">
        ...
        <ul>
          ...
          <a href="recepies.php"><button class="btn-filled-dark" id="gold1"   <?php echo  $_SESSION['user_data']['subscription']==''?'disabled':''; ?>> Checkout Recepies </button></a>
